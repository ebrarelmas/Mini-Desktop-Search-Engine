 ...
 * @author Ebrar Yıldız
 */
public class Ebrar_Fatma_BinarySearchTree {

    private Ebrar_Fatma_Node root;

    private Ebrar_Fatma_Node addNode(Ebrar_Fatma_Node node, String word) {
        if (node == null) {
            return new Ebrar_Fatma_Node(word);
        }
    ...
    // Kelime arama işlevi
    public int searchNode(Ebrar_Fatma_Node node, String word) {
        if (node == null) {
            return 0;
        }
    ...
    // In-order traversal
    public String inorderTraversal(Ebrar_Fatma_Node node) {
    ...
    // Pre-order traversal
    public String preorderTraversal(Ebrar_Fatma_Node node) {
        StringBuilder result = new StringBuilder(); // Dizini toplamak için bir StringBuilder kullanılır
    ...
    public String postorderTraversal(Ebrar_Fatma_Node node) {
